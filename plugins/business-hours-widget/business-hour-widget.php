 ...
 *
 * @package   Inhabitent_Business_Hour
 * @author    Billy Tam <BillyTam823@gmail.com>
 * @license   GPL-2.0+
 ...
 * Description:       A handy business hour widget for the Inhabitent website
 * Version:           1.0.0
 * Author:            Billy Tam
 * Author URI:        Null
 * License:           GPL-2.0+
...
class Inhabitent_Business_Hour extends WP_Widget {
...
add_action( 'widgets_init', function(){
     register_widget( 'Inhabitent_Business_Hour' );
});
